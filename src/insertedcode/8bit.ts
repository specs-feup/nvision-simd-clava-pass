export const FW_DECL_CODE_8: string = `
#include <stddef.h>

inline static void __mac_8b(int a, int b, int c, int d);
inline static void __dot_prod_8b(signed char *A, signed char *B, volatile int *accum,
                           size_t length);
`;

export const SW_MAC_CODE_8: string = `
inline static void __mac_8b(int a, int b, int c, int d) {
...
export const HW_MAC_CODE_8: string = `
inline static void __mac_8b(int a, int b, int c, int d) {
...
export const DOT_PROD_CODE_8: string = `
inline static void __dot_prod_8b(signed char *A, signed char *B, volatile int *accum,
                           size_t length) {
