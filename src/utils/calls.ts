...
export function getAllReferencesToVariablePassedToFunctionsInAfter(baseJp: Joinpoint, varDecl: Vardecl, referenceJp: Joinpoint, referenceInclusive: boolean = false): FunctionArgument[] {
    const callsThatReceivePointerToVariable = getFromAfter(baseJp, Call, referenceJp, call => {
